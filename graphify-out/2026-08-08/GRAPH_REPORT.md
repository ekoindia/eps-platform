...
## Corpus Check
- 706 files · ~861,492 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4191 nodes · 9787 edges · 219 communities (194 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `268a4146`
...
3. `SITE_URL` - 40 edges
4. `docsHref()` - 37 edges
5. `openZohoChat()` - 35 edges
6. `FadeIn()` - 33 edges
7. `productHref()` - 33 edges
8. `ApiSpec` - 29 edges
9. `EkoClient` - 27 edges
10. `KV` - 26 edges
...
Cohesion: 0.05
Nodes (55): NavLink, NavLinkCompatProps, CTASection(), LeadCaptureSection(), bbpsProducts, bcProducts, collectionProducts, handleChat() (+47 more)

### Community 4 - "build-openapi.ts"
Cohesion: 0.09
Nodes (33): API_DEFAULT_VERSION, API_AUTH_DOCS_URL, API_AUTH_INFO, API_ENVIRONMENTS, API_VERSION, ApiEnvironment, AUTH_HEADERS, resolveContentType() (+25 more)

### Community 5 - "render-recipe.ts"
Cohesion: 0.06
Nodes (59): ARC_TINTS, assignLanes(), edgeLabel(), FREQUENCY_FILL, FREQUENCY_TEXT, METHOD_FILL, METHOD_TEXT, nodeHoverRules() (+51 more)

### Community 6 - "ConsoleLayout.tsx"
Cohesion: 0.06
Nodes (50): ConsoleLayout(), ConsoleNav(), CREDENTIALS_ITEM, DOCUMENTS_ITEM, Flow, flowItem(), HOME_ITEM, MANAGE_ACCOUNT (+42 more)

### Community 7 - "resolveSteps.ts"
Cohesion: 0.09
Nodes (17): InputOTP, InputOTPGroup, InputOTPSlot, Label, labelVariants, PanStep(), PinStep(), ResolvedStep (+9 more)

### Community 8 - "code-samples.ts"
Cohesion: 0.20
Nodes (32): DEFAULT_BASE_URL, buildSampleRequest(), isMultipart(), pathTokens(), resolveRequestParams(), bodyParts(), CLIENT_LEVEL_PARAMS, clientLevelDefaults() (+24 more)

### Community 9 - "SignupWizard.tsx"
Cohesion: 0.13
Nodes (19): Step, StepMark(), Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle (+11 more)
...
Cohesion: 0.11
Nodes (15): ALL_METHODS, COMMON_REQUEST_PARAMS, COMMON_RESPONSE_ENVELOPE, CommonRequestParam, deriveLocation(), enabledSpecs(), FINANCIAL_RESPONSE_ENVELOPE, HttpMethod (+7 more)

### Community 12 - "payments-pricing.ts"
Cohesion: 0.10
Nodes (37): EarningsProductRow(), EarningsProductRowProps, nearestStepIndex(), TICK_LABELS, TXN_STEPS, parseSelectionFromParams(), PaymentsCalculator(), sanitizeTxns() (+29 more)

### Community 13 - "markdown/shared.ts"
Cohesion: 0.26
Nodes (26): SITE_URL, renderDocsIndexMarkdown(), FaqMarkdownItem, renderFaqMarkdown(), renderLlmsTxt(), renderSiteIndexMarkdown(), renderUseCasesHubMarkdown(), relevanceLabel (+18 more)

### Community 14 - "docs-registry.ts"
Cohesion: 0.07
Nodes (44): resolveRelatedLink(), NextStepLink(), ResponseTypes(), GuideMeta, GUIDES, SHOW_TRANSACT_MCP, ACTIVE_PRODUCTS_MAP, API_PRODUCTS (+36 more)

### Community 15 - "console/dashboard.ts"
Cohesion: 0.06
Nodes (45): BusinessDashboard(), isEmpty(), MostUsedServicesWidget, SuccessRatesWidget, load, view(), withServices(), UsageAnalyticsWidget (+37 more)
...
Cohesion: 0.19
Nodes (11): CodeBlock(), CodeBlockProps, exampleApiCode, exampleIntegrationSteps, examplePaymentCode, ComplianceSection(), DeveloperSection(), stepIcons (+3 more)
...
Cohesion: 0.10
Nodes (39): parseSelectionFromParams(), PricingCalculator(), sanitizeVolume(), SelectionEntry, serializeSelection(), ADD_API_EVENT, nearestStepIndex(), SelectedApiRow() (+31 more)

### Community 22 - "config.ts"
Cohesion: 0.06
Nodes (25): EkoLogLevel, Sessions, BusinessDetails, ZohoClient, Config, REQUIRED, base, baseEnv (+17 more)

### Community 23 - "render-pricing.ts"
Cohesion: 0.11
Nodes (31): displayName(), GST_RATE, HAS_VOLUME_DISCOUNTS, PRICING_FAQS, PRICING_GROUPS, SETUP_FEE_DISCOUNT_PERCENT, SETUP_FEE_DISCOUNTED, BBPS_OPERATORS (+23 more)

### Community 24 - "ProductPageLayout.tsx"
Cohesion: 0.07
Nodes (41): ApiChipProps, relevanceColors, ApiField, ApiInputOutputPreview(), ApiInputOutputPreviewProps, ApiPreviewItem, ApiSampleJson, MultiApiPreview() (+33 more)
...
Cohesion: 0.06
Nodes (33): DropdownColumnHeader(), DropdownGrid(), DropdownGridColumn, DropdownGridProps, MenuItemLink(), MenuItemLinkProps, pastelColors, AI_ASK_PROMPT (+25 more)

### Community 31 - "app.ts"
Cohesion: 0.08
Nodes (39): SecurityLogger, UpstreamSession, ACCESS_COOKIE, REFRESH_COOKIE, SessionClaim, AdminDeps, isAllowedKycFile(), KYC_EXTENSIONS (+31 more)
...
Cohesion: 0.09
Nodes (26): DATE_PRESETS, DAYS_BACK, formatIst(), IST_OFFSET_MS, istRange(), parsePreset(), PRESETS, startOfIstDay() (+18 more)

### Community 34 - "Transactions.tsx"
Cohesion: 0.11
Nodes (31): MostUsedServicesWidget(), isProvisioned(), creditOf(), debitOf(), deriveAmount(), describeRow(), hueOf(), inferSearchField() (+23 more)
...
Cohesion: 0.13
Nodes (22): AuthContext, AuthContextValue, AuthProvider(), classify(), Probe(), registeredHandler(), renderAuthed(), AdminView (+14 more)
...
### Community 40 - "GrievancePage.tsx"
Cohesion: 0.14
Nodes (3): LegalPageLayout(), LegalPageLayoutProps, SectionDivider()

### Community 41 - "CommandPalette.tsx"
Cohesion: 0.10
Nodes (32): CATEGORY_BADGE, CommandPalette(), CommandPaletteProps, escapeRegExp(), GROUPS, highlight(), ICON_TINT, ResultRow() (+24 more)
...
Cohesion: 0.13
Nodes (26): responseTypeFor(), buildNavTree(), docsHref(), CODE_SNIPPET_SETS, CodeSnippet, defaultSnippet(), RDSERVICE_ANDROID, SIGN_REQUEST (+18 more)

### Community 44 - "QuoteSummary.tsx"
Cohesion: 0.11
Nodes (26): MobileEstimateBarProps, MobileSummaryBar(), MobileSummaryBarProps, EarningsSummary(), EarningsSummaryProps, QUICK_ADD_PRODUCTS, QUICK_ADD_APIS, QuoteSummary() (+18 more)

### Community 45 - "ProfileCard.tsx"
Cohesion: 0.11
Nodes (14): LifecycleBadge(), kycEnabled, ProfileCard(), ME, HeaderDropdownPanels(), AuthState, Lifecycle, Profile (+6 more)

### Community 46 - "DocsIndexPage.tsx"
Cohesion: 0.11
Nodes (28): CopyButton(), NumberedCode(), TabButton(), CodeSamples(), MODES, LangIcon(), EPS_MCP_CMD, API_SPECS_MAP (+20 more)

### Community 47 - "http/dashboard.test.ts"
Cohesion: 0.10
Nodes (30): SAMPLE_DASHBOARD_OBJECT, SAMPLE_SERVICE_LIST, brokenCacheKv(), envelope(), harness(), upstream, DatePreset, block() (+22 more)
...
### Community 49 - "Footer.tsx"
Cohesion: 0.11
Nodes (10): state, FooterLinkItem, footerLinks, socialLinks, MiniToc(), MiniTocProps, TocEntry, PARENT_SITE_URL (+2 more)

### Community 50 - "Eko Platform Services (EPS) Brand"
Cohesion: 0.31
...
### Community 51 - "render-products-index.ts"
Cohesion: 0.16
Nodes (29): buildRelatedLinks(), productHref(), aepsPricing(), bbpsCommissionInline(), bbpsPricing(), benefitsBlock(), dmtPricing(), dmtSenderNotes (+21 more)
...
Cohesion: 0.07
Nodes (43): createSecurityLogger(), noopSecurityLogger, SecurityEvent, SecurityOutcome, SecurityRecord, capture(), createSessions(), baseEnv (+35 more)
...
### Community 60 - "NotificationBell.tsx"
Cohesion: 0.15
...
Cohesion: 0.14
Nodes (15): EndpointDetail(), buildInstallMatrix(), HARNESSES, HarnessInstall, HarnessMcp, HarnessPluginInstall, MCP_CMD, PluginInstallStep (+7 more)

### Community 65 - "site.ts"
Cohesion: 0.11
Nodes (24): AiHint(), DefaultMeta(), SITE_TITLE_SUFFIX, DocsLayout(), buildLlmPrompt(), copyText(), PageActions(), useTryIt() (+16 more)

### Community 66 - "TestDialogs.tsx"
Cohesion: 0.20
Nodes (8): useConnectDialogs(), ACCEPT_PRESETS, CameraTest(), FileUploadTest(), FileViewerTest(), ImageEditorTest(), RaiseIssueTest(), useEditorOptions()

### Community 67 - "EkoClient"
Cohesion: 0.07
Nodes (16): EkoClient, identityOf(), ekoCfg, mockFetch(), profileFrom(), profileFromDetail(), INTERACTION_154_SAMPLE, FILTER_RULES (+8 more)
...
### Community 72 - "SignAgreementStep.tsx"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (27): ConnectedBankingCalculator(), DEFAULT_INPUT, nearestStepIndex(), parseInputFromParams(), TICK_LABELS, TXN_STEPS, MobileEstimateBar(), AddButton() (+19 more)
...
### Community 78 - "connectProvider.ts"
Cohesion: 0.16
...
Cohesion: 0.14
Nodes (29): collectImpFields(), collectImpOutputs(), getApiPreviewsForProduct(), getDisplaySpecsForProduct(), getProductDocHref(), getVerifiableFieldsForProduct(), humanizeLabel(), isStatusSpec() (+21 more)
...
Cohesion: 0.07
Nodes (55): ApiChip(), BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES, FadeIn(), FadeInProps (+47 more)
...
Cohesion: 0.06
Nodes (33): localTime(), OutputRow(), SecretKeyTester(), accessKeyInput(), enterGoldenInputs(), GOLDEN, realCompute, timestampInput() (+25 more)

### Community 86 - "pdf-render.ts"
Cohesion: 0.21
...
Cohesion: 0.06
Nodes (28): AdminDocEditor(), getContent, propose, AdminDocsList(), LoginForm(), maskMobile(), adopt, refresh (+20 more)
...
Cohesion: 0.20
Nodes (9): 1. The pull loop, 2. The endpoints, 3. The view, 4. The surfaces, 5. Deliberately not ported from Eloka, 6. Phase 2: web push, Feature: Notifications, Terminal versus transient (+1 more)
...
### Community 95 - "eko.ts"
Cohesion: 0.07
Nodes (36): EkoLogEntry, EkoLogger, noopEkoLogger, REDACTED_REQUEST_FIELDS, REDACTED_RESPONSE_FIELDS, AccountDetail, isRealAccountId(), mapAccounts() (+28 more)

### Community 96 - "composer.json"
Cohesion: 0.13
Nodes (14): autoload, autoload-dev, psr-4, psr-4, description, license, name, Eko\\Eps\\ (+6 more)

### Community 97 - "build-agent-bundle.ts"
Cohesion: 0.14
Nodes (21): apiDetail(), buildAgentBundle(), buildApi(), buildIndex(), buildTopic(), buildTopics(), ENVIRONMENTS, fnv1aHex() (+13 more)
...
Cohesion: 0.08
Nodes (30): KycUploadDialog(), KycUploadDialogProps, slugify(), toastError, upload, configOf(), KYC_ACCEPT, KYC_DOC_CONFIG (+22 more)
...
Cohesion: 0.10
Nodes (28): FaqList(), ProductPageContent, FaqAccordion(), FaqItem, PARENT_SITE_NAME, SIGNUP_URL, SITE_LOGO_URL, API_PRODUCT_PAGES (+20 more)
...
### Community 121 - "AdminConsole.tsx"
Cohesion: 0.31
Nodes (4): AdminConsole(), Separator, Admin(), mockState
...
### Community 129 - "Header.tsx"
Cohesion: 0.11
Nodes (15): PrintReceipt(), EkoLogo(), EkoLogoProps, CommandPalette, HeaderDropdownPanels, LanguageSelector, HeaderDropdownPanelsProps, ScrollDirection (+7 more)
...
Cohesion: 0.08
Nodes (26): getApp(), handler(), AccessLogger, AccessRecord, createAccessLogger(), noopAccessLogger, sample, createEkoLogger() (+18 more)
...
Cohesion: 0.18
Nodes (13): acceptsImages(), acceptsNonImages(), acceptsOnlyImagesAndPdfs(), acceptsType(), FileUpload(), FileUploadOptions, FileUploadProps, formatBytes() (+5 more)
...
### Community 149 - "input.tsx"
Cohesion: 0.13
Nodes (10): ApiPicker(), ApiPickerProps, PickerRow(), Badge(), BadgeProps, badgeVariants, groupDigits(), Input (+2 more)

### Community 150 - "FileViewDialog.tsx"
Cohesion: 0.33
Nodes (6): FileViewDialog(), FileViewType, isSafeUrl(), sniffType(), toYouTubeEmbed(), TYPE_BY_EXTENSION

### Community 151 - "NotificationList.tsx"
Cohesion: 0.13
Nodes (17): DeployToProduction(), production, useOptionalConnectDialogs(), formatNotifyTime(), hasRichMedia(), NotificationDetail(), NotificationMedia, DialogContent (+9 more)
...
### Community 210 - "http/connect.test.ts"
Cohesion: 0.22
Nodes (6): developer, harness(), NOW, uploadHarness(), upstream(), withCookie
...
### Community 214 - "DocsNavTree.tsx"
Cohesion: 0.36
Nodes (7): collectActiveBranchIds(), DocsNavTree(), normalizePath(), soleBranchChain(), branch(), findSoleChildBranch(), NavBranch

### Community 216 - "build-postman.ts"
Cohesion: 0.27
...
### Community 217 - "reload-on-chunk-error.ts"
Cohesion: 0.36
Nodes (5): App(), installChunkErrorReload(), isChunkLoadError(), reloadOnceForStaleChunk(), doHydrate()

### Community 219 - "MdxGuide.tsx"
Cohesion: 0.15
Nodes (13): ALIAS, Callout(), CalloutVariant, VARIANTS, CodeSnippets(), CopyButton(), prismLang(), MDX_COMPONENTS (+5 more)

### Community 222 - "ErrorBoundary.tsx"
Cohesion: 0.24
...
## Knowledge Gaps
- **1090 isolated node(s):** `DAYS_BACK`, `upstream`, `MAX_NOTIFICATIONS`, `HeaderDropdownPanels`, `CommandPalette` (+1085 more)
...
- **Why does `doHydrate()` connect `reload-on-chunk-error.ts` to `app.test.ts`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `app()` connect `app.test.ts` to `reload-on-chunk-error.ts`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `requestId()` connect `app.test.ts` to `app.ts`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **What connects `DAYS_BACK`, `upstream`, `MAX_NOTIFICATIONS` to the rest of the system?**
