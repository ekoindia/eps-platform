...
Cohesion: 0.06
Nodes (48): ConsoleLayout(), ConsoleNav(), CREDENTIALS_ITEM, DOCUMENTS_ITEM, Flow, flowItem(), HOME_ITEM, MANAGE_ACCOUNT (+40 more)
...
Cohesion: 0.09
Nodes (28): Per-platform deploy/rewrite configs, ConsoleLayout (auth branches + left rail), Developer console (/console), My Profile page (/console/profile), PROFILE_DETAIL_BLOCKS allowlist, sessionStorage /me session cache, GET /wallet/balance BFF route (interaction 9), Module-scope wallet-balance cache (+20 more)
...
### Community 60 - "http/connect.test.ts"
Cohesion: 0.11
...
Cohesion: 0.10
Nodes (27): useConnectDialogs(), compressPdf(), extractPdfImages(), mergePdfs(), pdfFromImages(), pdfPageCount(), toBytes(), toPdfBlob() (+19 more)
...
Cohesion: 0.05
Nodes (37): ContextProbe(), DEVELOPER, mockNavigate, mockState, useConsoleMe(), NextStepsCard(), kycEnabled, ProfileCard() (+29 more)
...
Cohesion: 0.11
Nodes (26): call(), getWorker(), PdfCompressionResult, PdfFromImagesOptions, PdfSource, pending, reviveError(), EncryptedPdfError (+18 more)
...
Cohesion: 0.07
Nodes (36): KycUploadDialog(), KycUploadDialogProps, slugify(), toastError, upload, TooltipContent, authClient, configOf() (+28 more)
...
### Community 109 - "EkoShieldPage.tsx"
Cohesion: 0.12
...
### Community 129 - "DropdownGrid.tsx"
Cohesion: 0.20
...
### Community 132 - "Backend-only signed SDKs (@ekoindia/eps-sdk, ekoindia/eps-sdk PHP)"
Cohesion: 0.20
...
### Community 149 - "Edit Flow (Flow A) — propose changes as a PR"
Cohesion: 0.22
...
### Community 210 - "LanguageSelector.tsx"
Cohesion: 0.50
