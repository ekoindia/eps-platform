...
## Corpus Check
- 690 files · ~846,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4092 nodes · 9575 edges · 201 communities (176 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 212 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d0261640`
...
## Communities (201 total, 25 thin omitted)

### Community 0 - "build-agent-bundle.ts"
Cohesion: 0.04
Nodes (67): buildRelatedLinks(), NextSteps(), ResolvedLink, resolveRelatedLink(), AgentApiDetail, AgentApiIndexEntry, AgentAuthTopic, AgentBundle (+59 more)
...
Cohesion: 0.15
Nodes (16): STATE_COPY, NextStepsCard(), Step, kycEnabled, Card, CardContent, CardDescription, CardFooter (+8 more)

### Community 3 - "EkoShieldPage.tsx"
Cohesion: 0.07
Nodes (30): CodeBlock(), CodeBlockProps, exampleApiCode, exampleIntegrationSteps, examplePaymentCode, Picture(), PictureProps, complianceItems (+22 more)

### Community 4 - "api-specs-common.ts"
Cohesion: 0.06
Nodes (52): API_DEFAULT_VERSION, API_AUTH_DOCS_URL, API_AUTH_INFO, API_ENVIRONMENTS, API_VERSION, ApiEnvironment, AUTH_HEADERS, ApiProductId (+44 more)

### Community 5 - "RecipeFlowchart.tsx"
Cohesion: 0.08
Nodes (41): NextStepLink(), ARC_TINTS, assignLanes(), edgeLabel(), FREQUENCY_FILL, FREQUENCY_TEXT, METHOD_FILL, METHOD_TEXT (+33 more)
...
### Community 7 - "PricingCalculator.tsx"
Cohesion: 0.11
Nodes (22): MobileEstimateBar(), MobileEstimateBarProps, MobileSummaryBar(), MobileSummaryBarProps, parseSelectionFromParams(), PricingCalculator(), sanitizeVolume(), SelectionEntry (+14 more)

### Community 8 - "code-samples.ts"
Cohesion: 0.10
Nodes (54): CopyButton(), NumberedCode(), TabButton(), CodeSamples(), MODES, LangIcon(), LangId, DEFAULT_BASE_URL (+46 more)

### Community 9 - "admin.test.ts"
Cohesion: 0.11
Nodes (22): createSessions(), baseEnv, cfg, mk(), mountAdmin(), cfg, encHarness(), harness() (+14 more)
...
### Community 11 - "buildApp.ts"
Cohesion: 0.11
Nodes (20): getApp(), handler(), AccessRecord, createAccessLogger(), noopAccessLogger, sample, createEkoLogger(), FIELDS (+12 more)

### Community 12 - "payments-pricing.ts"
Cohesion: 0.11
Nodes (34): parseSelectionFromParams(), PaymentsCalculator(), sanitizeTxns(), serializeSelection(), PaymentsPicker(), PaymentsPickerProps, PickerRow(), ADD_EARNINGS_EVENT (+26 more)

### Community 13 - "render-pricing.ts"
Cohesion: 0.18
Nodes (40): SIGNUP_PAGE, productHref(), renderDocsIndexMarkdown(), faqBlocks(), FaqMarkdownItem, renderFaqMarkdown(), renderLlmsTxt(), renderSiteIndexMarkdown() (+32 more)

### Community 14 - "docs-registry.ts"
Cohesion: 0.06
Nodes (50): collectActiveBranchIds(), DocsNavTree(), normalizePath(), soleBranchChain(), branch(), findSoleChildBranch(), HttpMethodTag(), Method (+42 more)
...
### Community 17 - "render-products-index.ts"
Cohesion: 0.07
Nodes (45): SETUP_FEE_DISCOUNTED, ApiProductRef, specsToPreviews(), verifyHeading(), ProductPageDataShape, page, product, related (+37 more)
...
Cohesion: 0.11
Nodes (13): state, FooterLinkItem, footerLinks, socialLinks, XIcon(), TalkToSalesDialog(), TalkToSalesDialogProps, buildSrc() (+5 more)
...
Cohesion: 0.06
Nodes (70): BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES, FadeIn(), FadeInProps, TODO: Once `animation-timeline: view()` reaches baseline support across (+62 more)

### Community 22 - "signup.ts"
Cohesion: 0.08
Nodes (19): BusinessDetails, ZohoClient, BUSINESS_RULES, mountSignup(), parseBusiness(), cfgStub, foundProfile, harness() (+11 more)

### Community 23 - "KycUploadDialog.tsx"
Cohesion: 0.22
Nodes (11): DialogContent, DialogDescription, DialogFooter(), DialogHeader(), DialogOverlay, DialogTitle, ignoreNestedDialogInteraction(), outsideEvent() (+3 more)
...
### Community 26 - "cn"
Cohesion: 0.06
Nodes (46): FeatureCard(), FeatureCardProps, ProductCard(), ProductCardProps, StatCard(), StatCardProps, UseCaseCard(), UseCaseCardProps (+38 more)
...
Cohesion: 0.07
Nodes (36): Eps(), McpIcon(), IconComponent, MiniToc(), MiniTocProps, TocEntry, PARENT_SITE_URL, SITE_ORG_NAME (+28 more)

### Community 30 - "HeaderDropdownPanels.tsx"
Cohesion: 0.05
Nodes (47): DropdownColumnHeader(), DropdownGrid(), DropdownGridColumn, DropdownGridProps, MenuItemLink(), MenuItemLinkProps, pastelColors, CommandPalette (+39 more)

### Community 31 - "app.ts"
Cohesion: 0.08
Nodes (32): AccessLogger, SecurityLogger, UpstreamSession, ACCESS_COOKIE, REFRESH_COOKIE, SessionClaim, Sessions, AdminDeps (+24 more)
...
Cohesion: 0.10
Nodes (32): nearestStepIndex(), SelectedApiRow(), SelectedApiRowProps, TICK_LABELS, VOLUME_STEPS, calcLineCost(), calcQuote(), calcSetupFee() (+24 more)

### Community 34 - "Transactions.tsx"
Cohesion: 0.09
Nodes (39): MostUsedServicesWidget(), addApiToEstimate(), PricingTable(), RateRow(), Table, TableBody, TableCaption, TableCell (+31 more)

### Community 35 - "config.ts"
Cohesion: 0.07
Nodes (20): docTypeFromPath(), ENDPOINTS_DIR, GUIDES_DIR, isEditableDocPath(), slugFromPath(), createDocsService(), DocItem, cfg (+12 more)
...
Cohesion: 0.09
Nodes (33): compressPdf(), extractPdfImages(), imageToJpeg(), mergePdfs(), pdfFromImages(), pdfPageCount(), PdfSource, toBytes() (+25 more)

### Community 43 - "render-doc.ts"
Cohesion: 0.10
Nodes (31): codeColor(), ResponseAccordion(), Row, ResponseTypeNote(), ResponseTypes(), ApiResponseType, resolveResponseFields(), responseTypeFor() (+23 more)
...
### Community 46 - "PaymentsRateTable.tsx"
Cohesion: 0.20
Nodes (13): AddButton(), addProductToEstimate(), PaymentsRateTable(), slabRange(), slabValue(), AEPS_MINI_STATEMENT_COMMISSION, AEPS_SETTLEMENT_CHARGES, DMT_CUSTOMER_FEE_MIN (+5 more)
...
Cohesion: 0.14
Nodes (13): createSecurityLogger(), noopSecurityLogger, SecurityEvent, SecurityOutcome, SecurityRecord, capture(), captureLog(), callbackWith() (+5 more)
...
Cohesion: 0.08
Nodes (26): ContextProbe(), useConsoleMe(), HeaderDropdownPanels(), Profile, accountIdentity, detailField(), nameInitials(), profileCompleteness() (+18 more)
...
Cohesion: 0.19
Nodes (7): LifecycleCard(), ACTIVE, isProvisioned(), ConsoleHome(), ACTIVE, load, load
...
Cohesion: 0.20
Nodes (16): ConnectedBankingCalculator(), DEFAULT_INPUT, nearestStepIndex(), parseInputFromParams(), TICK_LABELS, TXN_STEPS, GST_RATE, calcCbQuote() (+8 more)
...
### Community 74 - "EarningsProductRow.tsx"
Cohesion: 0.11
Nodes (13): ApiPicker(), ApiPickerProps, EarningsProductRow(), EarningsProductRowProps, nearestStepIndex(), TICK_LABELS, TXN_STEPS, groupDigits() (+5 more)
...
Cohesion: 0.11
Nodes (15): cfg, cookies(), FOUND_PROFILE, loggedIn(), setup(), UPSTREAM, verifyReq(), runKvContract() (+7 more)

### Community 79 - "api-spec-previews.ts"
Cohesion: 0.17
Nodes (22): API_PRODUCTS, collectImpFields(), collectImpOutputs(), getApiPreviewsForProduct(), getDisplaySpecsForProduct(), getProductDocHref(), getVerifiableFieldsForProduct(), humanizeLabel() (+14 more)
...
Cohesion: 0.06
Nodes (52): CopyBtn(), CopyState, LogLine, nowTs(), qScoreColor(), RdServiceTester(), statusBadge(), localTime() (+44 more)

### Community 86 - "zoho-chat.ts"
Cohesion: 0.16
...
Cohesion: 0.05
Nodes (36): AdminConsole(), AdminDocEditor(), getContent, propose, AdminDocsList(), DeployToProduction(), production, Skeleton() (+28 more)
...
### Community 95 - "eko.ts"
Cohesion: 0.04
Nodes (51): EkoLogEntry, EkoLogger, noopEkoLogger, REDACTED_REQUEST_FIELDS, REDACTED_RESPONSE_FIELDS, createConnectAuthProvider(), cfg, LOGIN_OK (+43 more)
...
Cohesion: 0.09
Nodes (20): EndpointDetail(), RequestSection(), aeps, dmt, figureOf(), skipping, svgOf(), buildInstallMatrix() (+12 more)
...
### Community 143 - "LoginForm.tsx"
Cohesion: 0.32
Nodes (5): LoginForm(), maskMobile(), adopt, refresh, toastInfo
...
Cohesion: 0.12
Nodes (21): PickerRow(), EarningsSummary(), EarningsSummaryProps, QUICK_ADD_PRODUCTS, QUICK_ADD_APIS, QuoteSummary(), SetupFeeLine(), SetupFeeLineProps (+13 more)

### Community 212 - "AnimatedRoutes.tsx"
Cohesion: 0.40
Nodes (4): AnimatedRoutes(), AnimatedRoutesProps, PageTransition(), PageTransitionProps

### Community 213 - "wallet-balance.ts"
Cohesion: 0.20
...
## Knowledge Gaps
- **1072 isolated node(s):** `ConnectTokens`, `ekoCfg`, `TransactionHistoryInput`, `NOT_FOUND_CODES`, `AGREEMENT_ALREADY_SIGNED` (+1067 more)
...
- **Why does `doHydrate()` connect `ErrorBoundary.tsx` to `admin.test.ts`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `app()` connect `admin.test.ts` to `ErrorBoundary.tsx`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `requestId()` connect `admin.test.ts` to `app.test.ts`, `buildApp.ts`, `app.ts`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **What connects `ConnectTokens`, `ekoCfg`, `TransactionHistoryInput` to the rest of the system?**
...
- **Should `build-agent-bundle.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.04430379746835443 - nodes in this community are weakly interconnected._