...
Cohesion: 0.06
Nodes (44): AgentApiDetail, AgentApiIndexEntry, AgentBundleMeta, AgentEnvironment, AgentEnvironmentsTopic, AgentErrorsTopic, AgentGettingStartedTopic, AgentIndex (+36 more)
...
Cohesion: 0.08
Nodes (47): ApiChip(), ApiChipProps, relevanceColors, BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES (+39 more)
...
Cohesion: 0.07
Nodes (25): ConsoleLayout(), ConsoleNav(), CREDENTIALS_ITEM, DOCUMENTS_ITEM, Flow, flowItem(), HOME_ITEM, MANAGE_ACCOUNT (+17 more)
...
Cohesion: 0.05
Nodes (47): EndpointDetail(), HttpMethodTag(), Method, METHOD_STYLES, SHORT, Variant, buildRelatedLinks(), NextSteps() (+39 more)
...
Cohesion: 0.09
Nodes (38): collectActiveBranchIds(), DocsNavTree(), normalizePath(), soleBranchChain(), findSoleChildBranch(), GuideMeta, GUIDES, API_PRODUCTS (+30 more)
...
Cohesion: 0.05
Nodes (55): ProfileCard(), HeaderDropdownPanels(), IndustryPageLayout(), NavLink, NavLinkCompatProps, CTASection(), LeadCaptureSection(), bbpsProducts (+47 more)
...
Cohesion: 0.07
Nodes (38): ApiField, ApiInputOutputPreview(), ApiInputOutputPreviewProps, ApiPreviewItem, ApiSampleJson, MultiApiPreview(), SectionHeader(), TerminalHeader() (+30 more)
...
Cohesion: 0.07
Nodes (40): AdminConsole(), developer, logout, mockState, UserMenu(), DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem (+32 more)
...
Cohesion: 0.07
Nodes (51): TrackingParamCapture(), TrackingParamCapture(), AiHint(), DefaultMeta(), SITE_TITLE_SUFFIX, DocsLayout(), buildLlmPrompt(), copyText() (+43 more)
...
Cohesion: 0.12
Nodes (31): FaqList(), SIGNUP_URL, COMMON_API_FAQS, FAQ_TAGS, FaqLink, faqsByTag(), FaqTag, GLOBAL_FAQS (+23 more)
...
### Community 51 - "reload-on-chunk-error.ts"
Cohesion: 0.36
...
Cohesion: 0.08
Nodes (38): call(), extractPdfImages(), getWorker(), PdfCompressionResult, PdfFromImagesOptions, pdfPageCount(), PdfSource, pending (+30 more)
...
### Community 86 - "DocsIndexPage.tsx"
Cohesion: 0.13
Nodes (15): FieldList(), InlineCode(), AgentAuthTopic, API_DEFAULT_VERSION, API_AUTH_INFO, API_ENVIRONMENTS, API_VERSION, ApiEnvironment (+7 more)
...
Cohesion: 0.05
Nodes (36): AdminDocEditor(), getContent, propose, AdminDocsList(), DeployToProduction(), production, LoginForm(), maskMobile() (+28 more)

### Community 91 - "interactions.ts"
Cohesion: 0.09
Nodes (30): Profile, accountIdentity, chatIdentity, detailField(), nameInitials(), profileCompleteness(), SHOW_CONNECT_WIDGET, buildRoleTransactionList() (+22 more)
...
### Community 93 - "pdf-page-content.ts"
Cohesion: 0.36
...
Cohesion: 0.07
Nodes (36): KycUploadDialog(), KycUploadDialogProps, slugify(), toastError, upload, FileUploadOptions, FileUploadProps, WatermarkSpec (+28 more)
...
### Community 143 - "ErrorBoundary.tsx"
Cohesion: 0.29
