# Graph Report - eko-eps-website  (2026-08-17)

## Corpus Check
- 721 files · ~892,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4297 nodes · 10121 edges · 217 communities (193 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f8c6a83`
...
Cohesion: 0.06
Nodes (46): AgentApiDetail, AgentApiIndexEntry, AgentAuthTopic, AgentBundleMeta, AgentEnvironment, AgentEnvironmentsTopic, AgentErrorsTopic, AgentGettingStartedTopic (+38 more)
...
Cohesion: 0.11
Nodes (26): HeaderDropdownPanels(), AuthContext, AuthContextValue, AuthProvider(), classify(), Probe(), registeredHandler(), renderAuthed() (+18 more)

### Community 5 - "api-recipes.ts"
Cohesion: 0.06
Nodes (51): branch(), NextStepLink(), ARC_TINTS, assignLanes(), edgeLabel(), FREQUENCY_FILL, FREQUENCY_TEXT, METHOD_FILL (+43 more)

### Community 6 - "DialogHost.tsx"
Cohesion: 0.12
Nodes (23): CameraOptions, CameraResult, CameraDialog, CHROME, ConnectDialogs, DialogContext, DialogRequest, DialogResult (+15 more)

### Community 7 - "industries.ts"
Cohesion: 0.08
Nodes (28): ProductPageContent, API_PRODUCT_PAGES, ProductPageData, ProductPageSeo, VERIFICATION_STEPS_BASE, API_PRODUCTS_MAP, STALE_DISPLAY_CHIPS, ACTIVE_INDUSTRIES_LIST (+20 more)

### Community 8 - "DocsLayout.tsx"
Cohesion: 0.11
Nodes (17): DocsTheme, DocsThemeToggle(), MiniToc(), MiniTocProps, TocEntry, SheetContent, SheetContentProps, SheetDescription (+9 more)

### Community 9 - "api-pricing.ts"
Cohesion: 0.16
Nodes (24): applySetupFeeDiscount(), buildSetupFeeQuote(), calcLineCost(), calcQuote(), calcSetupFee(), clampDiscountPercent(), getRateForVolume(), PRICED_APIS (+16 more)
...
### Community 11 - "cn"
Cohesion: 0.06
Nodes (49): UserMenu(), FeatureCard(), FeatureCardProps, ProductCard(), ProductCardProps, StatCard(), StatCardProps, UseCaseCard() (+41 more)

### Community 12 - "payments-pricing.ts"
Cohesion: 0.13
Nodes (30): parseSelectionFromParams(), PaymentsCalculator(), sanitizeTxns(), serializeSelection(), PaymentsPicker(), PaymentsPickerProps, PickerRow(), ADD_EARNINGS_EVENT (+22 more)

### Community 13 - "markdown/shared.ts"
Cohesion: 0.18
Nodes (38): SIGNUP_PAGE, productHref(), recipeHref(), renderDocsIndexMarkdown(), FaqMarkdownItem, renderFaqMarkdown(), renderLlmsTxt(), renderSiteIndexMarkdown() (+30 more)

### Community 14 - "docs-registry.ts"
Cohesion: 0.09
Nodes (36): collectActiveBranchIds(), DocsNavTree(), normalizePath(), soleBranchChain(), findSoleChildBranch(), GuideMeta, GUIDES, SHOW_TRANSACT_MCP (+28 more)
...
Cohesion: 0.12
Nodes (22): connectInteractions, walletBalance, Status, walletBalance, WalletBalance(), buildRoleTransactionList(), fetchRoleTransactionList(), GroupChild (+14 more)

### Community 17 - "render-product.ts"
Cohesion: 0.12
Nodes (33): API_PRODUCTS, collectImpFields(), collectImpOutputs(), getApiPreviewsForProduct(), getDisplaySpecsForProduct(), getProductDocHref(), getVerifiableFieldsForProduct(), humanizeLabel() (+25 more)
...
Cohesion: 0.07
Nodes (38): KycUploadDialog(), KycUploadDialogProps, slugify(), toastError, upload, TooltipContent, DEFAULT_BLUR_THRESHOLD, configOf() (+30 more)
...
Cohesion: 0.06
Nodes (33): BusinessDetails, EkoErrorDetails, ZohoClient, errorBody(), requestId(), sanitizeRequestId(), app(), BUSINESS_RULES (+25 more)
...
### Community 24 - "ZohoSignupForm.tsx"
Cohesion: 0.36
...
### Community 26 - "render-pricing.ts"
Cohesion: 0.14
Nodes (24): GST_RATE, PRICING_FAQS, PRICING_GROUPS, PricingFaq, calcCbQuote(), CB_BANKS, CB_FAQS, CB_MAX_BANK_USERS (+16 more)
...
Cohesion: 0.06
Nodes (58): BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES, FadeIn(), FadeInProps, TODO: Once `animation-timeline: view()` reaches baseline support across (+50 more)

### Community 29 - "NotificationList.tsx"
Cohesion: 0.13
Nodes (20): useOptionalConnectDialogs(), formatNotifyTime(), hasRichMedia(), NotificationDetail(), NotificationList(), NotificationMedia, NotificationRow(), Thumbnail() (+12 more)

### Community 30 - "HeaderDropdownPanels.tsx"
Cohesion: 0.04
Nodes (47): PrintReceipt(), DropdownColumnHeader(), DropdownGrid(), DropdownGridColumn, DropdownGridProps, MenuItemLink(), MenuItemLinkProps, pastelColors (+39 more)

### Community 31 - "EndpointDetail.tsx"
Cohesion: 0.10
Nodes (18): RequestSection(), FieldList(), HttpMethodTag(), Method, METHOD_STYLES, SHORT, Variant, InlineCode() (+10 more)
...
Cohesion: 0.13
Nodes (28): MostUsedServicesWidget(), TableFooter, creditOf(), debitOf(), deriveAmount(), describeRow(), hueOf(), inferSearchField() (+20 more)
...
### Community 40 - "api-products.ts"
Cohesion: 0.06
Nodes (32): buildRelatedLinks(), NextSteps(), ResolvedLink, resolveRelatedLink(), ACTIVE_PRODUCTS_MAP, API_PRODUCTS_DATA, ApiProductCategory, ApiProductId (+24 more)

### Community 41 - "EkoShieldPage.tsx"
Cohesion: 0.11
Nodes (20): CTASection(), LeadCaptureSection(), handleChat(), TalkToSalesDialog(), formatMobile(), openZohoChat(), digitalProducts, EkoShieldPage() (+12 more)

### Community 42 - "render-products-index.ts"
Cohesion: 0.21
Nodes (22): aepsPricing(), bbpsCommissionInline(), bbpsPricing(), benefitsBlock(), dmtPricing(), dmtSenderNotes, faqBullets(), inlineList() (+14 more)

### Community 43 - "card.tsx"
Cohesion: 0.13
Nodes (17): SuccessRatesWidget(), NextStepsCard(), Step, StepMark(), kycEnabled, Card, CardContent, CardDescription (+9 more)
...
Cohesion: 0.05
Nodes (39): developer, logout, mockState, ConsoleLayout(), connectEkostoreToken, connectInteractions, DEVELOPER, ContextProbe() (+31 more)

### Community 51 - "ProductPageLayout.tsx"
Cohesion: 0.07
Nodes (43): ApiChip(), ApiChipProps, relevanceColors, ApiField, ApiInputOutputPreview(), ApiInputOutputPreviewProps, ApiPreviewItem, ApiSampleJson (+35 more)
...
Cohesion: 0.06
Nodes (53): getApp(), handler(), AccessRecord, createAccessLogger(), noopAccessLogger, sample, createEkoLogger(), createSecurityLogger() (+45 more)
...
Cohesion: 0.06
Nodes (38): InputOTP, InputOTPGroup, InputOTPSlot, Label, labelVariants, BUSINESS_FIELDS, BUSINESS_GROUPS, BusinessField (+30 more)
...
### Community 63 - "RaiseIssueDialog.tsx"
Cohesion: 0.17
...
Cohesion: 0.12
Nodes (28): ConnectedBankingCalculator(), DEFAULT_INPUT, nearestStepIndex(), parseInputFromParams(), TICK_LABELS, TXN_STEPS, AddButton(), addProductToEstimate() (+20 more)
...
### Community 70 - "PricingCalculator.tsx"
Cohesion: 0.15
Nodes (15): ApiPicker(), ApiPickerProps, parseSelectionFromParams(), PricingCalculator(), sanitizeVolume(), SelectionEntry, serializeSelection(), ADD_API_EVENT (+7 more)
...
Cohesion: 0.22
Nodes (7): agreementIdOf(), createEkoClient(), ekoCfg, mockFetch(), profileFrom(), profileFromDetail(), INTERACTION_154_SAMPLE

### Community 73 - "AiPage.tsx"
Cohesion: 0.07
Nodes (38): AntigravityIcon(), ClaudeCodeIcon(), CodexIcon(), CursorIcon(), HarnessIcon(), HarnessIconProps, ICON_MAP, KiroIcon() (+30 more)

### Community 74 - "SelectedApiRow.tsx"
Cohesion: 0.10
Nodes (15): EarningsProductRowProps, nearestStepIndex(), TICK_LABELS, TXN_STEPS, nearestStepIndex(), SelectedApiRowProps, TICK_LABELS, VOLUME_STEPS (+7 more)
...
### Community 78 - "ConsoleLayout.tsx"
Cohesion: 0.05
Nodes (37): SignInSplit(), STEPS, loginFormProps, ConsoleNav(), CREDENTIALS_ITEM, DOCUMENTS_ITEM, Flow, flowItem() (+29 more)

### Community 79 - "render-doc.ts"
Cohesion: 0.14
Nodes (29): FaqList(), COMMON_API_FAQS, FAQ_TAGS, FaqLink, faqsByTag(), FaqTag, GLOBAL_FAQS, GLOBAL_REFERENCE_FAQS (+21 more)
...
Cohesion: 0.21
Nodes (10): CodeSnippets(), CopyButton(), prismLang(), LangId, CODE_SNIPPET_SETS, CodeSnippet, getSnippetSet(), RDSERVICE_ANDROID (+2 more)

### Community 91 - "QuoteSummary.tsx"
Cohesion: 0.17
Nodes (20): PickerRow(), EarningsProductRow(), EarningsSummary(), EarningsSummaryProps, QUICK_ADD_PRODUCTS, QUICK_ADD_APIS, QuoteSummary(), SelectedApiRow() (+12 more)
...
### Community 94 - "app.ts"
Cohesion: 0.06
Nodes (44): noopSecurityLogger, AuthProvider, UpstreamSession, VerifyResult, ACCESS_COOKIE, REFRESH_COOKIE, SessionClaim, Sessions (+36 more)

### Community 95 - "CodeSamples.tsx"
Cohesion: 0.17
Nodes (18): CopyButton(), NumberedCode(), TabButton(), CodeSamples(), MODES, LangIcon(), SAMPLE_LANGS, SampleLang (+10 more)

### Community 96 - "composer.json"
Cohesion: 0.13
Nodes (14): autoload, autoload-dev, psr-4, psr-4, description, license, name, Eko\\Eps\\ (+6 more)

### Community 97 - "use-watermark.ts"
Cohesion: 0.27
Nodes (9): GeolocationState, IDLE, useGeolocation(), formatLocation(), joinWatermark(), FIX, useWatermarkText(), WatermarkFields (+1 more)

### Community 98 - "pdf-render.ts"
Cohesion: 0.20
Nodes (13): BLUR_ANALYSIS_MAX_LENGTH, findNonImageOp(), isPageImageOnly(), NON_IMAGE_OP_NAMES, NON_IMAGE_OPS, blurScorePdfPages(), drawToBlob(), extractImages() (+5 more)
...
Cohesion: 0.06
Nodes (41): EkoLogEntry, EkoLogger, noopEkoLogger, parseEkoLogLevel(), REDACTED_REQUEST_FIELDS, REDACTED_RESPONSE_FIELDS, FIELDS, RESPONSE (+33 more)
...
### Community 118 - "markdownTable"
Cohesion: 0.11
Nodes (21): AgentBundle, buildContextPackBody(), CONTEXT_PACK_FILES, ContextPackFile, body, bundle, withHeading(), buildInstallMatrix() (+13 more)
...
Cohesion: 0.10
Nodes (14): LegalPageLayout(), LegalPageLayoutProps, SectionDivider(), FaqPage(), GrievancePage(), IndustriesPage(), IndustryDetailPage(), PrivacyPolicyPage() (+6 more)
...
Cohesion: 0.09
Nodes (32): acceptsImages(), acceptsNonImages(), acceptsOnlyImagesAndPdfs(), acceptsType(), checkBlurOrExplain(), FileUpload(), FileUploadOptions, FileUploadProps (+24 more)
...
Cohesion: 0.09
Nodes (31): NotificationsCard(), items, markReadMock, panelMock, NotificationBell(), items, markReadMock, announce() (+23 more)

### Community 151 - "MarkdownCodeBlock.tsx"
Cohesion: 0.29
...
### Community 210 - "features.ts"
Cohesion: 0.19
Nodes (9): isProvisioned(), CONNECT_WIDGET_URL, SHOW_BUSINESS_DASHBOARD, SHOW_CONNECT_WIDGET, SHOW_NOTIFICATIONS, ConsoleHome(), ACTIVE, load (+1 more)

### Community 211 - "api-specs-common.ts"
Cohesion: 0.11
Nodes (18): EndpointDetail(), ALL_METHODS, COMMON_REQUEST_PARAMS, COMMON_RESPONSE_ENVELOPE, CommonRequestParam, deriveLocation(), enabledSpecs(), FINANCIAL_RESPONSE_ENVELOPE (+10 more)
...
### Community 214 - "GitHubClient"
Cohesion: 0.11
Nodes (4): AccessLogger, SecurityLogger, GitHubClient, Deps
...
## Knowledge Gaps
- **1109 isolated node(s):** `connectInteractions`, `connectEkostoreToken`, `DEVELOPER`, `NavItem`, `NavGroup` (+1104 more)
...
- **Why does `doHydrate()` connect `ErrorBoundary.tsx` to `signup.ts`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `app()` connect `signup.ts` to `ErrorBoundary.tsx`?**
  _High betweenness centrality (0.143) - this node is a cross-community bridge._
- **Why does `requestId()` connect `signup.ts` to `buildApp.ts`, `app.ts`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **What connects `connectInteractions`, `connectEkostoreToken`, `DEVELOPER` to the rest of the system?**
