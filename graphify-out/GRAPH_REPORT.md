...
## Corpus Check
- 711 files · ~878,733 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4249 nodes · 9979 edges · 217 communities (192 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 220 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8738730`
...
## Communities (217 total, 25 thin omitted)
...
Cohesion: 0.08
Nodes (31): AdminConsole(), connectInteractions, DEVELOPER, ME, AuthContext, AuthContextValue, AuthProvider(), AuthState (+23 more)

### Community 5 - "render-recipe.ts"
Cohesion: 0.08
Nodes (50): branch(), ARC_TINTS, assignLanes(), edgeLabel(), FREQUENCY_FILL, FREQUENCY_TEXT, METHOD_FILL, METHOD_TEXT (+42 more)
...
Cohesion: 0.12
Nodes (32): parseSelectionFromParams(), PaymentsCalculator(), sanitizeTxns(), serializeSelection(), PaymentsPicker(), PaymentsPickerProps, PickerRow(), PRICING_FAQS (+24 more)

### Community 13 - "markdown/shared.ts"
Cohesion: 0.18
Nodes (34): SIGNUP_PAGE, productNavNodes(), faqBlocks(), FaqMarkdownItem, renderFaqMarkdown(), renderLlmsTxt(), renderSiteIndexMarkdown(), renderUseCasesHubMarkdown() (+26 more)

### Community 14 - "docs-registry.ts"
Cohesion: 0.08
Nodes (43): collectActiveBranchIds(), DocsNavTree(), normalizePath(), soleBranchChain(), findSoleChildBranch(), GuideMeta, GUIDES, ApiProductCategory (+35 more)
...
Cohesion: 0.10
Nodes (22): AgentBundle, buildContextPackBody(), CONTEXT_PACK_FILES, ContextPackFile, body, bundle, withHeading(), buildInstallMatrix() (+14 more)
...
Cohesion: 0.09
Nodes (40): MobileSummaryBar(), parseSelectionFromParams(), PricingCalculator(), sanitizeVolume(), SelectionEntry, serializeSelection(), ADD_API_EVENT, nearestStepIndex() (+32 more)

### Community 22 - "EkoClient"
Cohesion: 0.06
Nodes (22): EkoLogLevel, BusinessDetails, EkoClient, ZohoClient, Config, REQUIRED, BUSINESS_RULES, mountSignup() (+14 more)
...
### Community 24 - "api-products.ts"
Cohesion: 0.11
Nodes (19): ApiChipProps, relevanceColors, ApiInputOutputPreviewProps, ApiPreviewItem, MultiApiPreview(), SectionHeader(), TerminalHeader(), isTabId() (+11 more)
...
Cohesion: 0.06
Nodes (30): ConsoleLayout(), ContextProbe(), DEVELOPER, mockNavigate, mockState, useConsoleMe(), LegalPageLayout(), LegalPageLayoutProps (+22 more)
...
Cohesion: 0.05
Nodes (34): DropdownColumnHeader(), DropdownGrid(), DropdownGridColumn, DropdownGridProps, MenuItemLink(), MenuItemLinkProps, pastelColors, state (+26 more)

### Community 31 - "app.ts"
Cohesion: 0.08
Nodes (31): createDocsService(), AccessLogger, SecurityLogger, UpstreamSession, ACCESS_COOKIE, SessionClaim, Sessions, AdminDeps (+23 more)
...
Cohesion: 0.09
Nodes (12): docTypeFromPath(), ENDPOINTS_DIR, GUIDES_DIR, isEditableDocPath(), slugFromPath(), DocItem, cfg, GitHubApiError (+4 more)

### Community 36 - "auth/client.ts"
Cohesion: 0.05
Nodes (31): AdminDocsList(), NextStepsCard(), kycEnabled, ResolvedStep, StepDefinition, StepStatus, StepSubmit, registry (+23 more)
...
### Community 40 - "PaymentsRateTable.tsx"
Cohesion: 0.11
Nodes (27): ADD_EARNINGS_EVENT, AddButton(), addProductToEstimate(), PaymentsRateTable(), slabRange(), slabValue(), addApiToEstimate(), PricingTable() (+19 more)
...
Cohesion: 0.07
Nodes (47): blurScorePdf(), call(), compressPdf(), extractPdfImages(), getWorker(), mergePdfs(), PdfCompressionResult, pdfFromImages() (+39 more)

### Community 43 - "render-doc.ts"
Cohesion: 0.13
Nodes (24): responseTypeFor(), CODE_SNIPPET_SETS, CodeSnippet, defaultSnippet(), RDSERVICE_ANDROID, SIGN_REQUEST, GOLDEN, collectLeaves() (+16 more)

### Community 44 - "Header.tsx"
Cohesion: 0.12
Nodes (17): CommandPalette, Header(), HeaderDropdownPanels, LanguageSelector, LanguageSelectorFallback(), NavDropdownButton(), HeaderDropdownPanelsProps, ScrollDirection (+9 more)

### Community 45 - "button.tsx"
Cohesion: 0.10
Nodes (28): CodeBlock(), CodeBlockProps, exampleApiCode, exampleIntegrationSteps, examplePaymentCode, ProfileCard(), HeaderDropdownPanels(), IntegrationStep (+20 more)
...
Cohesion: 0.10
Nodes (30): API_DEFAULT_VERSION, API_AUTH_INFO, API_ENVIRONMENTS, API_VERSION, ApiEnvironment, AUTH_HEADERS, spec(), buildOpenApiDocument() (+22 more)

### Community 50 - "connectProvider.ts"
Cohesion: 0.16
...
Cohesion: 0.09
Nodes (40): ApiField, ApiInputOutputPreview(), ApiSampleJson, FaqList(), Picture(), PictureProps, PictureSource, getIndustryIcon() (+32 more)
...
Cohesion: 0.06
Nodes (45): createSecurityLogger(), noopSecurityLogger, SecurityEvent, SecurityOutcome, SecurityRecord, capture(), createSessions(), REFRESH_COOKIE (+37 more)
...
Cohesion: 0.17
Nodes (14): identityOf(), AppEnv, requestId(), sanitizeRequestId(), app(), FILTER_RULES, mountTransactions(), parseFilters() (+6 more)
...
Cohesion: 0.10
Nodes (18): LoginForm(), maskMobile(), adopt, refresh, toastInfo, connectInteractions, walletBalance, Status (+10 more)
...
Cohesion: 0.22
Nodes (14): decode(), landscapeJpeg(), portraitJpeg(), A4_POINTS, embed(), getPageCount(), imagesToPdf(), loadDocument() (+6 more)
...
### Community 78 - "ConnectedBankingCalculator.tsx"
Cohesion: 0.18
Nodes (16): ConnectedBankingCalculator(), DEFAULT_INPUT, nearestStepIndex(), parseInputFromParams(), TICK_LABELS, TXN_STEPS, Slider, PricingFaq (+8 more)
...
Cohesion: 0.07
Nodes (56): ApiChip(), BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES, FadeIn(), FadeInProps (+48 more)
...
### Community 84 - "authClient"
Cohesion: 0.20
Nodes (10): GeolocationState, IDLE, useGeolocation(), formatLocation(), joinWatermark(), FIX, useWatermarkText(), WatermarkFields (+2 more)

### Community 85 - "SecretKeyTester.tsx"
Cohesion: 0.21
Nodes (11): CopyBtn(), CopyState, localTime(), OutputRow(), SecretKeyTester(), base64Bytes(), base64Utf8(), buildSignedHeaders() (+3 more)

### Community 86 - "render-products-index.test.ts"
Cohesion: 0.08
Nodes (21): ProductPageContent, ProductPageData, ApiProductId, ApiProductRef, ProductPageDataShape, page, product, related (+13 more)
...
Cohesion: 0.07
Nodes (40): KycUploadDialog(), KycUploadDialogProps, slugify(), toastError, upload, FileUploadOptions, TooltipContent, WatermarkSpec (+32 more)

### Community 91 - "SecretKeyTester.test.tsx"
Cohesion: 0.32
...
### Community 94 - "http/connect.ts"
Cohesion: 0.13
Nodes (19): isAllowedKycFile(), KYC_EXTENSIONS, KYC_TYPES, mountConnect(), developer, harness(), NOW, uploadHarness() (+11 more)

### Community 95 - "eko.ts"
Cohesion: 0.05
Nodes (40): EkoLogEntry, EkoLogger, noopEkoLogger, parseEkoLogLevel(), REDACTED_REQUEST_FIELDS, REDACTED_RESPONSE_FIELDS, FIELDS, RESPONSE (+32 more)
...
### Community 108 - "EkoShieldPage.tsx"
Cohesion: 0.12
Nodes (16): buildSrc(), ZohoSignupForm(), ZOHO_SIGNUP_EMBED_URL, digitalProducts, employmentProducts, financialProducts, gstinProducts, healthcareProducts (+8 more)

### Community 109 - "search-index.ts"
Cohesion: 0.24
Nodes (17): getActiveProducts(), getAllDocNodes(), API_CATEGORY_ICONS, buildApiItems(), buildEndpointItems(), buildFaqItems(), buildGuideItems(), buildIndustryItems() (+9 more)
...
### Community 111 - "RaiseIssueDialog.tsx"
Cohesion: 0.16
...
### Community 118 - "blur.ts"
Cohesion: 0.21
Nodes (15): BLUR_ANALYSIS_MAX_LENGTH, blurScore(), blurScoreFromImageFile(), blurScoreFromVideo(), BlurScoreOptions, getBlurScore(), lowestBlurScore(), scoresByFile (+7 more)
...
### Community 121 - "MarkdownCodeBlock.tsx"
Cohesion: 0.29
...
### Community 129 - "input.tsx"
Cohesion: 0.11
Nodes (14): AdminDocEditor(), getContent, propose, ApiPicker(), ApiPickerProps, PickerRow(), Badge(), BadgeProps (+6 more)
...
Cohesion: 0.13
Nodes (18): getApp(), handler(), AccessRecord, createAccessLogger(), noopAccessLogger, sample, createEkoLogger(), createEkoAuthProvider() (+10 more)
...
Cohesion: 0.16
Nodes (14): acceptsImages(), acceptsNonImages(), acceptsOnlyImagesAndPdfs(), acceptsType(), checkBlurOrExplain(), FileUpload(), FileUploadProps, formatBytes() (+6 more)
...
Cohesion: 0.15
Nodes (31): PRICING_GROUPS, SETUP_FEE_DISCOUNTED, productHref(), verifyHeading(), CB_BANKS, rateRow(), renderPricingMarkdown(), aepsPricing() (+23 more)

### Community 146 - "ConnectClient"
Cohesion: 0.15
...
### Community 213 - "RecipeFlowchart.test.tsx"
Cohesion: 0.22
...
## Knowledge Gaps
- **1101 isolated node(s):** `PriceTier`, `SetupFeePack`, `SETUP_FEE_PACKS`, `PRICING_GROUP_ORDER`, `QuoteLine` (+1096 more)
...
- **Why does `app()` connect `http/transactions.test.ts` to `ErrorBoundary.tsx`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `requestId()` connect `http/transactions.test.ts` to `app.test.ts`, `app.ts`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **What connects `PriceTier`, `SetupFeePack`, `SETUP_FEE_PACKS` to the rest of the system?**
