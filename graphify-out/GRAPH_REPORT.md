# Graph Report - eko-eps-website  (2026-08-02)

## Corpus Check
- 675 files · ~815,150 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3994 nodes · 9329 edges · 202 communities (179 shown, 23 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 209 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `75e22914`
...
Cohesion: 0.04
Nodes (68): EndpointDetail(), API_PRODUCTS_DATA, ApiProductCategory, ApiProductId, ApiProductRef, PRODUCTS_SECTION_SLUG, ALL_METHODS, ApiSpec (+60 more)
...
Cohesion: 0.07
Nodes (42): CodeBlock(), CodeBlockProps, exampleApiCode, exampleIntegrationSteps, examplePaymentCode, FadeIn(), FadeInProps, TODO: Once `animation-timeline: view()` reaches baseline support across (+34 more)

### Community 4 - "RdServiceTester.tsx"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (51): ARC_TINTS, assignLanes(), edgeLabel(), FREQUENCY_FILL, FREQUENCY_TEXT, METHOD_FILL, METHOD_TEXT, nodeHoverRules() (+43 more)
...
### Community 8 - "build-agent-bundle.ts"
Cohesion: 0.05
...
Cohesion: 0.17
Nodes (42): SIGNUP_PAGE, PRICING_GROUPS, productHref(), recipeHref(), CB_BANKS, renderDocsIndexMarkdown(), FaqMarkdownItem, renderFaqMarkdown() (+34 more)
...
### Community 19 - "render-products-index.ts"
Cohesion: 0.10
Nodes (44): collectImpFields(), collectImpOutputs(), getApiPreviewsForProduct(), getDisplaySpecsForProduct(), getProductDocHref(), getVerifiableFieldsForProduct(), humanizeLabel(), isStatusSpec() (+36 more)
...
### Community 23 - "AppServer.tsx"
Cohesion: 0.07
Nodes (54): AiHint(), BreadcrumbItem, BreadcrumbNav(), BreadcrumbNavProps, BreadcrumbVariant, VARIANT_STYLES, DefaultMeta(), SITE_TITLE_SUFFIX (+46 more)
...
Cohesion: 0.07
Nodes (34): Eps(), McpIcon(), IconComponent, MiniToc(), MiniTocProps, TocEntry, AboutPage(), roles (+26 more)
...
Cohesion: 0.03
Nodes (78): DropdownColumnHeader(), DropdownGrid(), DropdownGridColumn, DropdownGridProps, MenuItemLink(), MenuItemLinkProps, pastelColors, state (+70 more)
...
### Community 37 - "SolutionPageLayout.tsx"
Cohesion: 0.08
Nodes (32): SolutionCard(), SolutionCardProps, SolutionPageLayout(), SolutionPageLayoutProps, API_PRODUCTS_MAP, STALE_DISPLAY_CHIPS, ACTIVE_INDUSTRIES_LIST, ApiGridItem (+24 more)
...
Cohesion: 0.07
Nodes (38): CATEGORY_BADGE, CommandPalette(), CommandPaletteProps, escapeRegExp(), FIELD_WEIGHT, GROUPS, highlight(), ICON_TINT (+30 more)
...
### Community 60 - "search-index.ts"
Cohesion: 0.07
Nodes (44): FaqList(), MDX_COMPONENTS, MdxGuide(), ProductPageContent, GUIDE_COMPONENTS, SIGNUP_URL, API_PRODUCT_PAGES, hasProductPage() (+36 more)
...
### Community 72 - "render-doc.ts"
Cohesion: 0.14
Nodes (25): responseTypeFor(), docsHref(), CODE_SNIPPET_SETS, CodeSnippet, defaultSnippet(), RDSERVICE_ANDROID, SIGN_REQUEST, GOLDEN (+17 more)
...
### Community 94 - "build-install-matrix.ts"
Cohesion: 0.17
...
### Community 120 - "BusinessStep.test.tsx"
Cohesion: 0.27
...
### Community 132 - "ZohoSignupForm.tsx"
Cohesion: 0.36
...
### Community 143 - "SignAgreementStep.test.tsx"
Cohesion: 0.29
