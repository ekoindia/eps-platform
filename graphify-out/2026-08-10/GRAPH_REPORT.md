...
## Summary
- 4242 nodes · 10017 edges · 218 communities (194 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4b13da75`
...
Cohesion: 0.06
Nodes (21): SecurityLogger, Sessions, BusinessDetails, ZohoClient, AdminDeps, Deps, BUSINESS_RULES, mountSignup() (+13 more)
...
Cohesion: 0.09
Nodes (30): AiHint(), IndustryPageLayout(), PageHero(), PageHeroProps, EPS_TRANSACT_MCP_CMD, EPS_TRANSACT_MCP_PKG, EPS_TRANSACT_MCP_URL, PARENT_SITE_NAME (+22 more)
...
Cohesion: 0.18
Nodes (21): SIGNUP_URL, responseTypeFor(), docsHref(), endpointSlug(), defaultSnippet(), collectLeaves(), errorScenarioTypeCell(), expandCallouts() (+13 more)
...
Cohesion: 0.12
Nodes (21): assertRecipeSlugs build guard, RecipeStep.branches success-path data gap, Disable an API (disabled: true, never delete), /assets/* excluded from SPA-shell rewrite, Stale-chunk auto-reload, ErrorBoundary around routes, installChunkErrorReload / reloadOnceForStaleChunk, SEARCH_INDEX auto-generated at module scope (+13 more)
...
### Community 70 - "Footer.tsx"
Cohesion: 0.09
Nodes (20): CodeBlock(), CodeBlockProps, exampleApiCode, exampleIntegrationSteps, examplePaymentCode, state, FooterLinkItem, footerLinks (+12 more)
...
Cohesion: 0.07
Nodes (35): ApiInputOutputPreview(), EndpointDetail(), RequestSection(), FieldList(), HttpMethodTag(), Method, METHOD_STYLES, SHORT (+27 more)
...
### Community 86 - "config.ts"
Cohesion: 0.10
Nodes (14): EkoLogLevel, parseEkoLogLevel(), createConnectAuthProvider(), cfg, LOGIN_OK, setup(), ConnectClient, Config (+6 more)
...
### Community 95 - "eko.ts"
Cohesion: 0.06
Nodes (43): createEkoLogger(), EkoLogEntry, EkoLogger, noopEkoLogger, REDACTED_REQUEST_FIELDS, REDACTED_RESPONSE_FIELDS, FIELDS, RESPONSE (+35 more)
...
### Community 108 - "build-context-pack.ts"
Cohesion: 0.31
...
### Community 111 - "Backend-only signed SDKs (@ekoindia/eps-sdk, ekoindia/eps-sdk PHP)"
Cohesion: 0.20
...
### Community 121 - "MdxGuide renderer"
Cohesion: 0.29
Nodes (8): FAQ answers are markdown, Mutually exclusive FaqTag categories, CodeSnippets MDX component, FaqList MDX component, GUIDE_COMPONENTS registry (eager imports), MdxGuide renderer, RdServiceTester (UIDAI RDService device tester), renderGuideMarkdown (markdown twin of guides)
...
### Community 146 - "Edit Flow (Flow A) — propose changes as a PR"
Cohesion: 0.22
...
- **Should `api-specs-common.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.04543979227523531 - nodes in this community are weakly interconnected._