  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Eko Brand Colors
        eko: {
          gold: "hsl(var(--eko-gold))",
          "gold-hover": "hsl(var(--eko-gold-hover))",
          "gold-light": "hsl(var(--eko-gold-light))",
          navy: "hsl(var(--eko-navy))",
          "navy-light": "hsl(var(--eko-navy-light))",
          slate: "hsl(var(--eko-slate))",
          success: "hsl(var(--eko-success))",
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        'gold': '0 4px 14px 0 hsl(42 96% 54% / 0.3)',
        'navy': '0 4px 14px 0 hsl(195 91% 15% / 0.15)',
