	...
	return (
		<>
			<Helmet>
				...
				<meta
					name="description"
					content="Explore Eko's API solutions for every industry — lending, microfinance, insurance, retail, logistics, and more. Find the right stack for your business."
				/>
				...
				<main>
						...
						<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
							...
							<FadeIn onView={false} delay={100} className="text-center">
								...
								<h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
									Find the right APIs for your industry
								</h1>
							</FadeIn>
							<FadeIn onView={false} delay={200} className="text-center">
								<p className="text-xl text-white/70 max-w-2xl mx-auto">
									See how businesses in your sector use Eko's APIs to verify,
									transact, and grow.
								</p>
							</FadeIn>
						</div>
					...
					{INDUSTRY_CATEGORIES.map((cat) => (
						<SectionContainer
							key={cat.key}
							variant={
								cat.key === "agent-retail" || cat.key === "workforce-fleet"
									? "muted"
									: "default"
							}
						>
