...
const blogPosts = [
	{
		...
		description:
			"Discover how API-driven financial services are bridging the banking gap for underserved communities across India.",
	...
	},
	{
		...
		description:
			"Step-by-step walkthrough of integrating Aadhaar verification APIs into your fintech application.",
	...
	},
	{
		...
		description:
			"Learn how to handle high-volume UPI disbursements reliably with Eko's Payout APIs.",
	...
	},
	{
		...
		description:
			"Understanding RBI guidelines and how Eko ensures every API meets regulatory standards.",
	...
	return (
		<div className="min-h-screen bg-background">
			<Helmet>
				...
				<meta
					name="description"
					content="Insights, guides, updates, and media coverage on fintech APIs, payments, KYC verification, and India's financial infrastructure from Eko Platform Services."
				/>
			</Helmet>
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-3xl mx-auto text-center mb-12">
						...
						<p className="text-lg text-muted-foreground">
							Insights, developer guides, updates, and media coverage from the
							Eko Platform Services team.
						</p>
					</div>
