...
import ekoShieldLogo from "@/assets/eko-shield-logo.png?w=64;128&format=avif;webp&as=picture";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-8 py-12 print:px-0 print:py-0 text-gray-900">
        ...
        <div className="text-center mb-16 print:mb-10">
          <Picture src={ekoShieldLogo} alt="Eko Shield" sizes="64px" className="h-16 mx-auto mb-6" />
