        ...
        <main>
          ...
          <SectionContainer className="bg-eko-navy">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                ...
                <FadeIn key={s.step} delay={s.step * 100} className="text-center">
          ...
          <SectionContainer>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              <FadeIn><StatCard value="50,000+" label="Businesses" icon={Users} /></FadeIn>
              <FadeIn delay={100}><StatCard value="200K+" label="Agent touchpoints" icon={Building2} /></FadeIn>
              <FadeIn delay={200}><StatCard value="99.9%" label="Uptime" icon={Shield} /></FadeIn>
              <FadeIn delay={300}><StatCard value="RBI" label="Compliant" icon={BarChart3} /></FadeIn>
            </div>
          </SectionContainer>
