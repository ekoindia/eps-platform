			...
			<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
				...
				<FadeIn>
					...
					<p className="text-lg text-muted-foreground mb-8 leading-relaxed">
						Whether you're looking to integrate our APIs or explore our platform
						solutions, our team is here to help you find the right fit.
					</p>
				...
				<FadeIn delay={200} className="relative min-w-0">
					...
					<div className="relative bg-card border border-border/50 rounded-2xl p-8 lg:p-10 shadow-xl">
						<h3 className="text-xl font-semibold text-foreground mb-2">
							Get Started with Eko Platform Services
						</h3>
