      ...
      <div className="absolute inset-0">
        ...
        >
          <defs>
            ...
            <pattern id="hero-grid" x="0" y="0" width="96" height="96" patternUnits="userSpaceOnUse">
              <path d="M 96 0 L 0 0 0 96" fill="none" stroke="rgba(255,255,255,0.03)" strokeWidth="1" />
            </pattern>
          </defs>
