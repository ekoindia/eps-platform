...
const bcProducts = [
	{
		...
		icon: Banknote,
		description:
			"Enable instant money transfers across India with real-time settlements.",
		features: [
			"IMPS & NEFT support",
	...
	},
	{
		...
		icon: Fingerprint,
		description:
			"Aadhaar-enabled payment services for rural and underbanked segments.",
...
const bbpsProducts = [
	...
	},
	{
		...
		icon: Wallet,
		description:
			"Cash Management System for streamlined cash collection and reconciliation.",
		features: [
...
export const ProductsSection = () => {
	...
	return (
		<SectionContainer id="products">
			...
			{activeTab === "payments" && (
				<ProductTabContent products={paymentProducts} />
			)}
			{activeTab === "bbps" && <ProductTabContent products={bbpsProducts} />}
			{activeTab === "collection" && (
				<ProductTabContent products={collectionProducts} />
			)}
			{activeTab === "verification" && (
				<ProductTabContent products={verificationProducts} />
			)}
