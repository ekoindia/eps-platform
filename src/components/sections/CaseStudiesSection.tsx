...
const caseStudies = [
	{
		...
		description:
			"How a leading fintech processed 10M+ monthly transactions with 99.9% success rate.",
	...
	},
	{
		...
		description:
			"A digital lending platform reduced customer onboarding time from days to minutes.",
	...
	},
	{
		...
		description:
			"A banking correspondent scaled to 50,000+ retail points using Ekonic platform.",
