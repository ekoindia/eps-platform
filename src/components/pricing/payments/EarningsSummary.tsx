 ...
 */
export const EarningsSummary = ({ quote, onQuickAdd }: EarningsSummaryProps) => {
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card shadow-card overflow-hidden">
      <div className="bg-eko-navy px-5 py-4">
        <h3 className="text-white font-bold">Your estimated monthly earnings</h3>
      ...
      <div className="p-5">
        ...
        <p className="text-[11px] text-muted-foreground/80 mt-4 leading-relaxed">
          ...
          one-time ₹11 KYC charge. AePS settlements carry a ₹5–₹10 + GST
          charge. BBPS rates vary by operator — see the Excel rate card.
        </p>
      </div>
    </div>
  );
