  ...
  const summary = (
    <div className="rounded-2xl border border-border/60 bg-card shadow-card overflow-hidden">
      <div className="bg-eko-navy px-5 py-4">
        <h3 className="text-white font-bold">Your Connected Banking estimate</h3>
      ...
      <div className="p-5">
        ...
        <p className="text-[11px] text-muted-foreground/80 mt-4 leading-relaxed">
          Setup fee applies per bank per user. Per-transaction charges depend
          on the transaction amount slab.
        </p>
      </div>
    </div>
  );
              ...
              <div className="shrink-0 sm:w-36">
                <div className="relative">
                  <Input
                    ...
                    onChange={(e) =>
                      handleNumericInput(e.target.value, "monthlyTxns", 10_000_000)
                    }
                    aria-label="Monthly transaction count"
          ...
          <div className="rounded-2xl border border-border/60 bg-card shadow-card p-4 sm:p-5">
            ...
            <div className="relative sm:w-48">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNumericInput(e.target.value, "avgAmount", CB_MAX_TXN_AMOUNT)
                }
