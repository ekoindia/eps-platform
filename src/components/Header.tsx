      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Button variant={isScrolled ? "ghost" : "hero-outline"} size="sm" className={isScrolled ? "text-eko-navy" : ""}>
              Sign In
            </Button>
          ...
          <div className="lg:hidden mt-4 pb-4 border-t border-white/10 pt-4">
            <nav className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-3 mt-4">
                <Button variant={isScrolled ? "navy-outline" : "hero-outline"} size="sm">Sign In</Button>
                <Button variant="gold" size="sm">Get Started</Button>
              </div>
            </nav>
          </div>
