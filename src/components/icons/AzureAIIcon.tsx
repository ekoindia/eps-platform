/**
 * AzureAI mark. Inlined from @lobehub/icons-static-svg (slug: azureai) as a
 * currentColor SVG so it adapts to surrounding text color. One layer keeps its
 * reduced fill-opacity to preserve the original depth effect.
 */
export const AzureAIIcon = ({ className }: { className?: string }) => (
	<svg
		viewBox="0 0 24 24"
		fill="currentColor"
		fillRule="evenodd"
