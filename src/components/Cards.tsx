...
export const ProductCard = ({ title, description, features, icon: Icon, className }: ProductCardProps) => {
  return (
    <div className={cn(
...
export const StatCard = ({ value, label, icon: Icon, className }: StatCardProps) => {
  return (
    <div className={cn(
      "text-center p-6",
      className
...
export const UseCaseCard = ({ title, description, icon: Icon, className }: UseCaseCardProps) => {
  return (
    <div className={cn(
