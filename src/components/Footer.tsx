          ...
          */}
					<div className="col-span-2 md:col-span-3 lg:col-span-2">
						...
						<div className="flex flex-col gap-3 text-sm">
							<a
								href="mailto:eps@eko.in"
								className="flex items-center gap-3 text-white/70 hover:text-eko-gold transition-colors cursor-pointer"
							>
								<Mail className="w-4 h-4 text-eko-gold" />
								<span>eps@eko.in</span>
							</a>
							<a
								id="lnk-sales-phone-footer"
							...
							<a
								href="https://share.google/WoimNHTmqaNqJnKxs"
								target="_blank"
								rel="noopener noreferrer"
								className="flex items-start gap-3 text-white/70 hover:text-eko-gold transition-colors cursor-pointer"
							>
			...
			<div className="border-t border-white/10">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
					<p className="text-white/60 text-sm text-center">
						© {new Date().getFullYear()} Eko Bharat Ventures Private Limited.
						All rights reserved.
					</p>
				</div>
			</div>
