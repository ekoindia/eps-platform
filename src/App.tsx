...
const ConsolePayActivationFee = lazy(
	() => import("./pages/console/PayActivationFee"),
);
...
const App = ({
	...
	<HelmetProvider context={helmetContext}>
		...
		<TooltipProvider>
          ...
          The provider itself is a context plus an empty stack, so it costs
          nothing until a dialog is actually asked for. */}
