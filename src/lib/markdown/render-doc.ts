...
export function renderDocsIndexMarkdown(): string {
	...
	return joinBlocks([
		...
		bulletList([
			`**Get credentials** — Eko's UAT/sandbox is self-serve. Sign up at ${SITE_URL}/console with your mobile number, verify with your PAN, and test our verification APIs live. Once you are satisfied, goto ${SITE_URL}/ai to integrate quickly with our free AI tools (MCP servers, plugins, skills, etc for your coding agent). ${API_ENVIRONMENTS.production.note}`,
