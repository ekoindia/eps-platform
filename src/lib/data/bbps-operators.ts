...
const ROWS: OperatorRow[] = [
	...
	["ICICI Prudential Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	...
	["Tata AIA Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	...
	["Birla Sun Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	...
	["Bangalore Water Supply", "Water", 1.2, 1.2, "pct"],
	["Torrent Power Ltd.", "Electricity", 1.2, 1.2, "fixed"],
	["SBI Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	...
	["Uttarakhand Jal Sansthan", "Water", 1.2, 1.2, "pct"],
	["Assam Power Distribution Company", "Electricity", 1.2, 1.2, "fixed"],
	["Municipal Corporation of Gurugram", "Municipal Corp", 0.72, 1.82, "fixed"],
	["Mumbai Metro", "Metro", 0.8, 0.8, "fixed"],
	["Bajaj Finance Ltd (Overdue)", "EMI Payments", 0.72, 0.72, "fixed"],
	["Bajaj Allianz Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	...
	["Delhi Jal Board", "Water", 1.2, 1.2, "pct"],
	["Haryana Urban Development Authority", "Water", 1.2, 1.2, "pct"],
	...
	["Flexsalary", "EMI Payments", 0.72, 0.72, "fixed"],
	["L&T Financial Services", "EMI Payments", 0.72, 0.72, "fixed"],
	["Tata Capital Financial Services", "EMI Payments", 0.72, 0.72, "fixed"],
	["Shriram City Union Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Indiabulls Housing Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["IIFL Finance Limited", "EMI Payments", 0.72, 0.72, "fixed"],
	["IIFL Home Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["HDB Financial Services", "EMI Payments", 0.72, 0.72, "fixed"],
	["Muthoot Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Bajaj Housing Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["LIC Housing Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Kotak Mahindra Bank - Loans", "EMI Payments", 0.72, 0.72, "fixed"],
	["ICICI Bank - Loans", "EMI Payments", 0.72, 0.72, "fixed"],
	["Axis Bank - Retail Loan", "EMI Payments", 0.72, 0.72, "fixed"],
	["Shriram Transport Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Mahindra & Mahindra Financial", "EMI Payments", 0.72, 0.72, "fixed"],
	["TVS Credit", "EMI Payments", 0.72, 0.72, "fixed"],
	["Tata Motors Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["CreditAccess Grameen", "EMI Payments", 0.72, 0.72, "fixed"],
	["Spandana Sphoorty Financial", "EMI Payments", 0.72, 0.72, "fixed"],
	["Ujjivan Small Finance Bank", "EMI Payments", 0.72, 0.72, "fixed"],
	["Equitas SFB - Microfinance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Equitas SFB - Retail Loan", "EMI Payments", 0.72, 0.72, "fixed"],
	["Suryoday Small Finance Bank", "EMI Payments", 0.72, 0.72, "fixed"],
	["Jana Small Finance Bank", "EMI Payments", 0.72, 0.72, "fixed"],
	["Fincare Small Finance Bank", "EMI Payments", 0.72, 0.72, "fixed"],
	["Unity Small Finance Bank", "EMI Payments", 0.72, 0.72, "fixed"],
	["Muthoot Microfin Limited", "EMI Payments", 0.72, 0.72, "fixed"],
	["Muthoot Fincorp Ltd", "EMI Payments", 0.72, 0.72, "fixed"],
	["Bharat Financial Inclusion", "EMI Payments", 0.72, 0.72, "fixed"],
	["Annapurna Finance (MSME)", "EMI Payments", 0.72, 0.72, "fixed"],
	["Annapurna Finance (MFI)", "EMI Payments", 0.72, 0.72, "fixed"],
	["Five Star Business Finance", "EMI Payments", 0.72, 0.72, "fixed"],
	["Poonawalla Fincorp Ltd", "EMI Payments", 0.72, 0.72, "fixed"],
	["Cholamandalam Investment", "EMI Payments", 0.72, 0.72, "fixed"],
	["HDFC Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Max Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["IndiaFirst Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Kotak Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Reliance Nippon Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Reliance General Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Star Health & Allied Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Aditya Birla Health Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["ICICI Lombard General Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Magma HDI - Health Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Magma HDI - Life Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Manipal Cigna Health Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Royal Sundaram General Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Go Digit Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Chola Insurance", "Insurance", 1.74, 3.76, "fixed"],
	["Fee Payment", "Education", 1.74, 1.74, "fixed"],
